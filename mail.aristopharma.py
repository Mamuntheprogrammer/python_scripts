...
last="January February March April May June July August September October November December".split()[last_month-1]
...
Please see the attached files for Target sheets of Pharma,AG and Ophtha {}-{}.

** Sorry for having some technical issues, please ignore all previous mail regarding the Target sheet for October. **

Kind Regards ,
Md.Abdullah Al Mamun
Executive | IT | Aristopharma Ltd.
📞Phone: 019599-23349
📧Email: almamun.it@aristopharma.com



""".format(last,last_year)
    ...
    mailServer = smtplib.SMTP("mail.aristopharma.com")
    # mailServer.ehlo()
    # mailServer.starttls()
    # mailServer.ehlo()
    # mailServer.login(gmail_user, gmail_pwd)
    text = msg.as_string().encode('utf8', 'ignore')
...
# dicm={
# 1310:'almamun.it@aristopharma.com',
# 1311:'monzur.it@aristopharma.com'
# }
